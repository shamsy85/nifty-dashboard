...
def get_access_token():
    ...
    with sync_playwright() as p:
        # Launch browser with anti-bot flags to prevent page load hangs
        ...
        try:
            ...
            page.wait_for_selector(mobile_selector, state="visible", timeout=45000)
            ...
            page.wait_for_selector(otp_selector, state="visible", timeout=45000)
            ...
            page.wait_for_selector(pin_selector, state="visible", timeout=45000)
            page.fill(pin_selector, pin)
            page.click(submit_btn)

            # Step 4: Extract Authorization Code from Redirect URL
            print("Waiting for OAuth redirect...")
            page.wait_for_url(f"{redirect_uri}*", timeout=45000)
